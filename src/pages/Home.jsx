...
export const Home = () => {
  ...
  return (    
    ...
    <div className='producto1'>
      ...
      <button type="button" className="btn btn-custom"><Link className='enlace' to="/producto/1">Más información</Link></button>
    </div>
    <div className='producto1'>
      ...
      <button type="button" className="btn btn-custom"><Link className='enlace' to={`/producto/2`} >Más información</Link></button>
    </div>
    </div>
    </>
